...
export const skills = [
  {
    title: 'Frontend',
    color: 'from-neon/30 via-blue-500/30 to-sky-400/30',
    items: [
      { name: 'React', level: 92 },
  ...
  {
    title: 'Backend',
    color: 'from-emerald-300/25 via-emerald-500/25 to-cyan-400/25',
    items: [
  ...
  {
    title: 'Design',
    color: 'from-amber-300/25 via-orange-400/25 to-rose-400/25',
    items: [
      { name: 'UI/UX', level: 90 },
      { name: 'Figma', level: 82 },
      { name: 'Adobe XD', level: 74 },
      { name: 'Motion', level: 70 },
    ],
  },
  {
    title: 'Tools',
    color: 'from-purple-300/25 via-indigo-400/25 to-slate-500/25',
    items: [
  ...
  {
    title: 'Soft Skills',
    color: 'from-pink-300/25 via-red-400/25 to-amber-400/25',
    items: [
...
export const projects = [
  {
    title: 'Hotel Website',
    description: 'Elegant hotel experience with cultural ceremony booking, historical highlights, and modern UX.',
    live: null,
    github: 'https://github.com/Bekalu-Temesgen-2306/gegerland-hotel-web-app',
    tech: ['React.js', 'Node.js', 'Mongo DB', 'Tailwind'],
    category: 'Fullstack',
    image: '/images/projects/hotel-website.png',
  },
  {
    title: 'FixItNow web app',
    description: 'easy mentenance tracking experience with user friendly issue applying , previous highlights, and modern UX.',
    live: null,
    github: 'https://github.com/Bekalu-Temesgen-2306/fixitnow',
